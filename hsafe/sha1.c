...
{
  sha1result* result = sha1_result(hash);
  sha1_result2hex(result, output);
}
...
void sha1_print(sha1result* hash) {
  int i;
  for (i=0; i<20; i++) {
